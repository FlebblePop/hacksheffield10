...
public class GameState {
    ...
    private final Scene scene1 = new Scene(1, "tavern",
    ...
    private final Scene scene4 = new Scene(4, "island",
            "You managed to get to shore safely, as you regain your breath, you look around the island to find a small sandy shore with a few trees and not much more.\n\nAvailable actions:\n- rescuer: (message)\n- Gather resources\n- Create an SOS sign",
